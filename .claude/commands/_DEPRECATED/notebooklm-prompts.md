...
- Customized for your script's specific claims once written

**B-Roll Shot List Prompt:**
- Tailored to your topic's visual evidence needs

## What I Need From You

1. **Topic and thesis:** What myth are you debunking? What's your argument?
2. **Sources uploaded:** What did you upload to NotebookLM? (Or should I use the `/suggest-sources` recommendations?)
3. **Specific questions:** Any particular aspects you want NotebookLM to focus on?
...
Saved to: `video-projects/[topic-slug]/04-notebooklm-prompts.md`

You'll copy each prompt, paste into NotebookLM, and collect responses.

---

**What's your topic and thesis?**
