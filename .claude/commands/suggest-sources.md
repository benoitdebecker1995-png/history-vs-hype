...
I'll recommend 20-30 authoritative sources (up to 50 if all essential) for your NotebookLM research.
...
I'll use your deep research report. If you haven't run `/deep-research` yet, I'll ask:
1. Topic
2. Research gaps
3. Key scholars identified
...
Saved to: `video-projects/[topic-slug]/03-source-recommendations.md`

---

Ready to find the best sources for your topic?

[Follow the source-recommender.md skill process]
