...
- Listed in style guide but missing from WRITING-VOICE-AND-STYLE-P1-CORE-VOICE.md / -P5-TECHNIQUES.md / -P7-NEWSLETTER.md
...
- Does NOT modify WRITING-VOICE-AND-STYLE-P1-CORE-VOICE.md / -P5-TECHNIQUES.md / -P7-NEWSLETTER.md
