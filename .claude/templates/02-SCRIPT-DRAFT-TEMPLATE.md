...
## MAIN CLAIM TO DEBUNK (0:45-1:00) [~25-35 words]

[Quote opponent's exact claim]

**Verification Reference:** ✅ [Line # from 01-VERIFIED-RESEARCH.md - opponent's quote verified]

**Visual:** [Show their video clip or talking head]

---

## STRUCTURE TELEGRAPH (1:00-1:15) [~25-35 words]

**Goal:** Tell viewers what's coming so they know to stay

"In this video, I'm going to show you [X], then explain [Y], and finally reveal [Z]."

**Visual:** [Talking head]

---

## CONTEXT SECTION (1:15-2:00) [~80-90 words]

**Goal:** Set up historical background needed to understand the debunk

[Provide necessary context - what happened, when, key players]

**Verification References:**
- Date: ✅ [Line # from 01-VERIFIED-RESEARCH.md]
- Context: ✅ [Line # from 01-VERIFIED-RESEARCH.md]

**Visual:** [Map, timeline, or talking head]
...
**Examples:**
- "This myth is still used to justify [current policy]..."
- "Understanding what actually happened matters because [modern consequence]..."

**Verification Reference:** ✅ [Modern relevance from line # of 01-VERIFIED-RESEARCH.md]

**Visual:** [Modern news footage, maps of current situation, or talking head]
...
**Critical:**
- [ ] Every fact references line # from 01-VERIFIED-RESEARCH.md
- [ ] No claims without verification
- [ ] All quotes exact word-for-word (no paraphrasing)
- [ ] All numbers match verified table in 01-VERIFIED-RESEARCH.md
- [ ] All archival refs match verified list in 01-VERIFIED-RESEARCH.md
- [ ] Contested claims labeled as debated (not presented as settled)

**Source Attribution:**
- [ ] Every quote has attribution ("According to historian X...")
- [ ] Every statistic has source ("The Höfle Telegram records...")
- [ ] Archival docs have exact references (catalogue numbers)

---

## VERIFICATION NOTES

[As you write, note which lines reference which verified facts - this makes Phase 3 cross-check faster]

**Example:**
- Line 56 (Fulcher quote): ✅ Verified - Quote #1 from 01-VERIFIED-RESEARCH.md
- Line 113 (Höfle archive ref): ✅ Verified - Reference #1 from 01-VERIFIED-RESEARCH.md
- Line 125 (Death toll): ✅ Verified - Numbers table line 89 from 01-VERIFIED-RESEARCH.md

---

## PROCEED TO PHASE 3?

**If all ✅ → Create `03-FACT-CHECK-VERIFICATION.md` for final cross-check**
**If any ❌ → Fix before proceeding**

**Remember:** This script should be 95% assembly of verified facts, 5% narrative flow. If you're "figuring out" facts while writing, STOP - go verify them first in 01-VERIFIED-RESEARCH.md.
