...
**Last advanced:** 2026-05-05 (L2)
**Total steps:** 47
**Done:** 46 (A1/B1/B2/B3/B6/C1/C2/C3/C4/C5/D1/D2/D3/E2/E3/F1 reconciled; A2/B4/B5 executed 2026-05-03; D4/E1/E4/E5/F2/F3/G1/G2/G3/G4/H1/H2/H3 executed 2026-05-04; H4/H5 executed 2026-05-05; I1/I2/I3/I4/J1/J2/J3 executed 2026-05-05; K1/K2 executed 2026-05-05; L1/L2 executed 2026-05-05)
...
## H1 [DONE] Pin current `database.py` behavior with a comprehensive test
...
## H2 [DONE] Design partition into `KeywordStore`, `IntentClassifier`, `PerformanceTracker`
...
## H5 [DONE] Implement `IntentClassifier`, retire `database.py` shell
...
## I1 [DONE] Pin translation pipeline behavior
...
## I2 [DONE] Design `DocumentTranslationPipeline` seam
...
## I3 [DONE] Implement `DocumentTranslationPipeline`, migrate the `/translate` slash command
...
## J1 [DONE] Pin script-analysis behavior
...
## J2 [DONE] Introduce `ScriptAnalysis` class in `tools/production/script_analysis.py`
...
## J3 [DONE] Apply deletion test to `metadata.py` and either inline or keep
...
## K1 [DONE] Define `KeywordPayload` dataclass and migrate `intake_parser`
...
## K2 [DONE] Migrate remaining dict-callers to `KeywordPayload`
...
## L1 [DONE] Pin script-checkers CLI behavior
...
## L2 [DONE] Introduce `CheckerRegistry`
