...
description: "Phase-organised menu of every workflow in this project and what each is for. Use when: asked what commands or skills exist here, what can be done in this repo, or which workflow fits a task."
---

> **Codex note.** This is the Codex port of `.claude/commands/help.md`, which stays canonical.
