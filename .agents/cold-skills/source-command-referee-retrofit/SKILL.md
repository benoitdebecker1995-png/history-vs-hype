---
name: source-command-referee-retrofit
description: "Retrofits an existing video or script to the document-led referee standard. Use when: an older piece needs to meet the current on-screen-evidence standard."
---

> **Codex note.** This is the Codex port of `.claude/commands/referee-retrofit.md`, which stays canonical.
