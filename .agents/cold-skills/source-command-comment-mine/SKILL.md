---
name: source-command-comment-mine
description: "Mines competitor YouTube comments to measure real audience demand for a thesis angle. Use when: deciding between angles, checking whether viewers actually ask about something, or grounding a video's premise in observed rather than assumed demand."
---

> **Codex note.** This is the Codex port of `.claude/commands/comment-mine.md`, which stays canonical.
