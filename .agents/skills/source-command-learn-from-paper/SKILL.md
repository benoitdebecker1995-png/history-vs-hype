---
name: source-command-learn-from-paper
description: "Mines an academic article for transferable structural, voice and evidence-handling lessons via NotebookLM, then outputs diff proposals for the writing agents. Use when: a paper is worth learning craft from rather than facts."
---

> **Codex note.** This is the Codex port of `.claude/commands/learn-from-paper.md`, which stays canonical.
