...
class TestDiagnoseSectionDrop:
    ...
    def test_abstract_opening_detection(self):
        ...
        from tools.youtube_analytics.section_diagnostics import diagnose_section_drop
...
class TestDiagnoseAllDrops:
    ...
    def test_diagnose_multiple_drops(self):
        ...
        from tools.youtube_analytics.section_diagnostics import diagnose_all_drops
...
class TestFormatDiagnosticsMarkdown:
    ...
    def test_format_diagnostics_report(self):
        ...
        from tools.youtube_analytics.section_diagnostics import format_diagnostics_markdown
        ...
        # Updated: format_diagnostics_markdown uses '12.0%' float format, not '12%'
        assert '12' in result  # Covers both '12%' and '12.0%' formats
