...
- [ ] **TITLE-03**: Tool auto-rejects titles with year (-46% CTR), colon (-28%), "The X That Y" (1.2% CTR), and question (-36%) patterns before presenting to user
...
- [ ] **META-02**: Thumbnail concept generator reads script, outputs 3 concepts (split-map conflict, document-on-map, geo+evidence) with specific visual elements
